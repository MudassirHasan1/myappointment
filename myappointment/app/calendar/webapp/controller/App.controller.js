sap.ui.define([
    ...
    function (Label, Popover, coreLibrary, DateFormat, Fragment, Controller, JSONModel, Log, UI5Date) {
        ...
        return Controller.extend("calendar.controller.App", {
            ...
            onInit: async function () {
                ...
                // var oOperationTemplate = oModel.bindContext("/getAppointments(...)");

                // await oOperationTemplate.execute().then(function () { });
